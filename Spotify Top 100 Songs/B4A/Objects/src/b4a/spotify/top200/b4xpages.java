...
public static b4a.spotify.top200.b4xpagesdelegator _delegate = null;
...
public static b4a.spotify.top200.b4xpagesmanager._b4amenuitem  _addmenuitem(anywheresoftware.b4a.BA _ba,Object _b4xpage,Object _title) throws Exception{
RDebugUtils.currentModule="b4xpages";
if (Debug.shouldDelegate(null, "addmenuitem", true))
	 {return ((b4a.spotify.top200.b4xpagesmanager._b4amenuitem) Debug.delegate(null, "addmenuitem", new Object[] {_ba,_b4xpage,_title}));}
...
if (true) return _getmanager(_ba)._addmenuitem /*b4a.spotify.top200.b4xpagesmanager._b4amenuitem*/ (null,_b4xpage,_title);
RDebugUtils.currentLine=2162690;
 //BA.debugLineNum = 2162690;BA.debugLine="End Sub";
return null;
}
public static b4a.spotify.top200.b4xpagesmanager  _getmanager(anywheresoftware.b4a.BA _ba) throws Exception{
RDebugUtils.currentModule="b4xpages";
if (Debug.shouldDelegate(null, "getmanager", true))
	 {return ((b4a.spotify.top200.b4xpagesmanager) Debug.delegate(null, "getmanager", new Object[] {_ba}));}
...
if (true) return (b4a.spotify.top200.b4xpagesmanager)(_mpm);
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.spotify.top200.b4xpagesmanager._b4xpageinfo*/ (null,_b4xpage).Parent /*b4a.spotify.top200.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ ;
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.spotify.top200.b4xpagesmanager._b4xpageinfo*/ (null,_b4xpage).Id /*String*/ ;
...
if (true) return _mpm instanceof b4a.spotify.top200.b4xpagesmanager;
RDebugUtils.currentLine=1310722;
 //BA.debugLineNum = 1310722;BA.debugLine="End Sub";
return false;
}
public static b4a.spotify.top200.b4xmainpage  _mainpage(anywheresoftware.b4a.BA _ba) throws Exception{
RDebugUtils.currentModule="b4xpages";
if (Debug.shouldDelegate(null, "mainpage", true))
	 {return ((b4a.spotify.top200.b4xmainpage) Debug.delegate(null, "mainpage", new Object[] {_ba}));}
...
if (true) return _getmanager(_ba)._mainpage /*b4a.spotify.top200.b4xmainpage*/ ;
