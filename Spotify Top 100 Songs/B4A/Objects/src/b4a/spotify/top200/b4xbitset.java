...
public class b4xbitset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "b4a.spotify.top200.b4xbitset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.spotify.top200.b4xbitset.class).invoke(this, new Object[] {null});
        else
...
public String  _class_globals(b4a.spotify.top200.b4xbitset __ref) throws Exception{
__ref = this;
...
public String  _clear(b4a.spotify.top200.b4xbitset __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xbitset";
...
public boolean  _get(b4a.spotify.top200.b4xbitset __ref,int _index) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xbitset";
...
public int  _getsize(b4a.spotify.top200.b4xbitset __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xbitset";
...
public String  _initialize(b4a.spotify.top200.b4xbitset __ref,anywheresoftware.b4a.BA _ba,int _size) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xbitset";
...
public String  _set(b4a.spotify.top200.b4xbitset __ref,int _index,boolean _value) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xbitset";
