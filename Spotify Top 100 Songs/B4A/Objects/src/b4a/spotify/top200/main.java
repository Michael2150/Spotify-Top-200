...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.spotify.top200", "b4a.spotify.top200.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.spotify.top200", "b4a.spotify.top200.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.spotify.top200.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ (null);
...
if (true) return mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (null,_keycode);
...
mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._activity_pause /*String*/ (null);
...
mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (null,_permission,_result);
...
mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._activity_resume /*String*/ (null);
...
mostCurrent._b4xpages._delegate /*b4a.spotify.top200.b4xpagesdelegator*/ ._create_menu /*String*/ (null,_menu);
