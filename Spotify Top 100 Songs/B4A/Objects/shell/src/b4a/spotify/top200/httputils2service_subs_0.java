...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,115);
if (RapidSub.canDelegate("completejob")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
...
_job.runClassMethod (b4a.spotify.top200.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,90);
if (RapidSub.canDelegate("hc_responseerror")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.spotify.top200.httpjob");
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,71);
if (RapidSub.canDelegate("hc_responsesuccess")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.spotify.top200.httpjob");
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,82);
if (RapidSub.canDelegate("response_streamfinish")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,23);
if (RapidSub.canDelegate("service_create")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(536870912);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","68323079",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 31;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(1073741824);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","68323080",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,52);
if (RapidSub.canDelegate("service_destroy")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,48);
if (RapidSub.canDelegate("service_start")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,58);
if (RapidSub.canDelegate("submitjob")) { return b4a.spotify.top200.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
Debug.ShouldStop(1073741824);
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.spotify.top200.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 65;BA.debugLine="hc.Execute(job.GetRequest, taskCounter)";
Debug.ShouldStop(1);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.spotify.top200.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(httputils2service._taskcounter));
 };
