...
if (RapidSub.canDelegate("createbitset")) { return b4a.spotify.top200.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createbitset", _ba, _size);}
RemoteObject _s = RemoteObject.declareNull("b4a.spotify.top200.b4xbitset");
;
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4a.spotify.top200.b4xbitset");Debug.locals.put("s", _s);
 BA.debugLineNum = 54;BA.debugLine="s.Initialize(Size)";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4a.spotify.top200.b4xbitset.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba),(Object)(_size));
...
if (RapidSub.canDelegate("createorderedmap")) { return b4a.spotify.top200.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap", _ba);}
;
...
if (RapidSub.canDelegate("createorderedmap2")) { return b4a.spotify.top200.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap2", _ba, _keys, _values);}
RemoteObject _m = RemoteObject.declareNull("b4a.spotify.top200.b4xorderedmap");
int _i = 0;
;
...
Debug.JustUpdateDeviceLine();
_m = RemoteObject.createNew ("b4a.spotify.top200.b4xorderedmap");Debug.locals.put("m", _m);
 BA.debugLineNum = 40;BA.debugLine="m.Initialize";
Debug.JustUpdateDeviceLine();
_m.runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba));
...
Debug.JustUpdateDeviceLine();
_m.runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)(_keys.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),(Object)(_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 }
}Debug.locals.put("i", _i);
;
 };
...
if (RapidSub.canDelegate("createset")) { return b4a.spotify.top200.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset", _ba);}
;
...
if (RapidSub.canDelegate("createset2")) { return b4a.spotify.top200.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset2", _ba, _values);}
RemoteObject _s = RemoteObject.declareNull("b4a.spotify.top200.b4xset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4a.spotify.top200.b4xset");Debug.locals.put("s", _s);
 BA.debugLineNum = 18;BA.debugLine="s.Initialize";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4a.spotify.top200.b4xset.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba));
...
Debug.JustUpdateDeviceLine();
_s.runClassMethod (b4a.spotify.top200.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(_v));
 }
}Debug.locals.put("v", _v);
;
 };
