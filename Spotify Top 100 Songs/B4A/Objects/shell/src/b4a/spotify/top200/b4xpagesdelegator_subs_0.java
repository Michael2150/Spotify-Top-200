...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_activity_actionbarhomeclick" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
if (true) return b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_activity_keypress" /*RemoteObject*/ ,(Object)(_keycode));
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_activity_pause" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_raiseevent" /*RemoteObject*/ ,(Object)(b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_gettoppage" /*RemoteObject*/ )),(Object)(BA.ObjectToString("B4XPage_PermissionResult")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_permission),(_result)})));
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_activity_resume" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_createmenu" /*RemoteObject*/ ,(Object)(_menu));
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (b4a.spotify.top200.b4xpagesmanager.class, "_mainform_resize" /*RemoteObject*/ ,(Object)(_width),(Object)(_height));
