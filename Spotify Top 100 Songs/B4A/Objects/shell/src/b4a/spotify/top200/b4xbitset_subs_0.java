...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",6,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.b4xbitset.class, "_clear" /*RemoteObject*/ );
