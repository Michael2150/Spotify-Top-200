...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,248);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,206);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,211);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeDelete",(Object)(__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,176);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,186);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_req" /*RemoteObject*/ ).runVoidMethod ("InitializeGet",(Object)(__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_escapelink" /*RemoteObject*/ ,(Object)(_link),(Object)(_parameters))));
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,191);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,263);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,274);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,270);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,280);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,243);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,224);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_getstring2" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("UTF8")));
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,229);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_patchbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,148);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","99568263",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_out.runMethod(false,"ToBytesArray")));
 }else {
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,91);
...
RemoteObject _fd = RemoteObject.declareNull("b4a.spotify.top200.httpjob._multipartfiledata");
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.InputStreamWrapper");
Debug.locals.put("Link", _link);
...
Debug.JustUpdateDeviceLine();
_empty = __ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_multipartstartsection" /*RemoteObject*/ ,(Object)(_stream),(Object)(_empty));Debug.locals.put("empty", _empty);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_stream.runMethod(false,"ToBytesArray")));
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,40);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_postbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.spotify.top200.httpjob.class, "_putbytes" /*RemoteObject*/ ,(Object)(_link),(Object)(_text.runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",14,__ref.getField(false, "ba"),__ref,217);
