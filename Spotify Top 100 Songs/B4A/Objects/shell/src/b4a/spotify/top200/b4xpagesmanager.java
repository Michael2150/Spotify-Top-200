...
public static RemoteObject _idtob4xpage = RemoteObject.declareNull("b4a.spotify.top200.b4xorderedmap");
public static RemoteObject _rootb4xtopage = RemoteObject.declareNull("b4a.spotify.top200.b4xorderedmap");
public static RemoteObject _context = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
public static RemoteObject _mstackofpageids = RemoteObject.declareNull("b4a.spotify.top200.b4xset");
...
public static RemoteObject _mainpage = RemoteObject.declareNull("b4a.spotify.top200.b4xmainpage");
