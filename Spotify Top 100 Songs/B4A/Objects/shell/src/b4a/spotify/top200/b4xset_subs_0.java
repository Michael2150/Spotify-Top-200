...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)(_value),(Object)((RemoteObject.createImmutable(""))));
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
b4xset._map = RemoteObject.createNew ("b4a.spotify.top200.b4xorderedmap");__ref.setField("_map",b4xset._map);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_clear" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)(_value));
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4a.spotify.top200.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)(_value));
