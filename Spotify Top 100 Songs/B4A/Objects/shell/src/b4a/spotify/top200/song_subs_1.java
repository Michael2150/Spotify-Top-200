...
try {
		Debug.PushSubsStack("GetSummary (song) ","song",4,__ref.getField(false, "ba"),__ref,19);
if (RapidSub.canDelegate("getsummary")) { return __ref.runUserSub(false, "song","getsummary", __ref);}
 BA.debugLineNum = 19;BA.debugLine="Public Sub GetSummary As String";
Debug.ShouldStop(262144);
 BA.debugLineNum = 20;BA.debugLine="Return $\" (${Rank}) ${CRLF} ${SongName} ${CRLF} $";
